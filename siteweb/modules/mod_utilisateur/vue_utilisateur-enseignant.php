...
require_once 'core/modelegenerique.php'; // Inclure le modèle générique

class VueUtilisateur extends ModeleGenerique {
    public function afficherPageAcceuil() {
        ...
        $stmt = $this->bdd->prepare("SELECT nom FROM enseignant WHERE id_enseignant = :id_enseignant");
